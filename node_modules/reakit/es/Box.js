...
import { a as bool$1, b as bgColorWithProps, c as textColorWithProps } from './chunk-bbbc8dce.js';
...
var BoxComponent = forwardRef(function (_ref, ref) {
  ...
  if (typeof T === "string") {
    ...
    return createElement(T, _extends({}, allProps, {
      ref: applyAllRefs(ref, props.elementRef)
    }));
  }

  return createElement(T, _extends({}, props, {
    style: style
  }));
});
...
})(["margin:unset;padding:unset;border:unset;background:unset;font:unset;font-family:inherit;font-size:100%;box-sizing:border-box;background-color:", ";color:", ";", ";&&&{", ";}"], bgColorWithProps, textColorWithProps, theme("Box"), bool$1("position", positions));
var useTypes = [func, string, object]; // @ts-ignore

Box.propTypes = {
  use: oneOfType(useTypes.concat([arrayOf(oneOfType(useTypes))])),
  opaque: bool,
  palette: string,
  tone: number,
  static: bool,
