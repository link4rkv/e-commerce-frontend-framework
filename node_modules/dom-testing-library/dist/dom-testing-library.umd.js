(function (global, factory) {
  ...
  */
  ...
  var collections = createCommonjsModule(function (module, exports) {
    ...
    exports.printIteratorEntries = // Return entries (for example, of a map)
  ...
  var convert_ansi = createCommonjsModule(function (module, exports) {
    ...
    var toHumanReadableAnsi = function (text) {
      return text.replace((0, _ansiRegex2.default)(), function (match) {
        switch (match) {
  ...
  var dom_collection = createCommonjsModule(function (module, exports) {
    ...
    var convertCollectionToObject = function (collection) {
      var result = {};
    ...
    var serialize = exports.serialize = function (collection, config, indentation, depth, refs, printer) {
      ...
      return collection.constructor.name + ' ' + '{' + (0, collections.printObjectProperties)(convertCollectionToObject(collection), config, indentation, depth, refs, printer) + '}';
    };
  ...
  var markup = createCommonjsModule(function (module, exports) {
    ...
    var _escape_html2 = function (obj) {
      return obj && obj.__esModule ? obj : {
        default: obj
      };
    ...
    exports.printProps = function (keys, props, config, indentation, depth, refs, printer) {
      var indentationNext = indentation + config.indent;
    ...
    exports.printChildren = function (children, config, indentation, depth, refs, printer) {
    ...
    exports.printComment = function (comment, config) {
    ...
    exports.printElement = function (type, printedProps, printedChildren, config, indentation) {
      var tagColor = config.colors.tag;
      return tagColor.open + '<' + type + (printedProps && tagColor.close + printedProps + config.spacingOuter + indentation + tagColor.open) + (printedChildren ? '>' + tagColor.close + printedChildren + config.spacingOuter + indentation + tagColor.open + '</' + type : (printedProps && !config.min ? '' : ' ') + '/') + '>' + tagColor.close;
    };

    exports.printElementAsLeaf = function (type, config) {
      var tagColor = config.colors.tag;
  ...
  var dom_element = createCommonjsModule(function (module, exports) {
    ...
    var keysMapper = function (attribute) {
  ...
  var build = createCommonjsModule(function (module) {
    ...
    var getColorsHighlight = function (options // $FlowFixMe: Flow thinks keys from `Colors` are missing from `DEFAULT_THEME_KEYS`
    ) {
